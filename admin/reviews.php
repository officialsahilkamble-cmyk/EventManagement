    ...
    <div class="ml-64">
        <header class="header flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-600">Moderate event reviews</p>
            </div>
        ...
        <main class="p-6">
            <div class="card">
                <div class="text-center py-12">
                    <i class="fas fa-star text-6xl text-purple-300 mb-4"></i>
                    <h3 class="text-xl font-semibold text-gray-800 mb-2">Review Moderation Coming Soon</h3>
                    <p class="text-gray-600">Review management features will be available here.</p>
                </div>
            </div>
        </main>
    </div>
